...
```python
for mov in Movie.objects.order_by('-opening_date'):
     print(mov.director.name, mov.genre.title, mov.title, mov.opening_date, mov.running_time, mov.screening)
```
...
```python
mov = Movie.objects.order_by('opening_date')[0]
print(mov.director.name, mov.genre.title, mov.title, mov.opening_date, mov.running_time, mov.screening)
```
...
```python
for mov in Movie.objects.filter(screening = True).order_by('opening_date'):
	print(mov.director.name, mov.genre.title, mov.title, mov.opening_date, mov.running_time, mov.screening)
```
...
```python
bong = Director.objects.get(name='봉준호')
for mov in Movie.objects.filter(director = bong).order_by('opening_date'):
	print(mov.director.name, mov.genre.title, mov.title, mov.opening_date, mov.running_time, mov.screening)
```
...
```python
bong = Director.objects.get(name='봉준호')
mov = Movie.objects.filter(director = bong).order_by('opening_date')[1]
print(mov.director.name, mov.genre.title, mov.title, mov.opening_date, mov.running_time, mov.screening)
```
...
```python
for mov in Movie.objects.filter(running_time__gt= 119).order_by('running_time'):
	print(mov.director.name, mov.genre.title, mov.title, mov.opening_date, mov.running_time, mov.screening)
```
...
```python
for mov in Movie.objects.filter(running_time__gte= 119).order_by('running_time'):
	print(mov.director.name, mov.genre.title, mov.title, mov.opening_date, mov.running_time, mov.screening)
```
...
```python
for mov in Movie.objects.filter(opening_date__gt= '2022-01-01').order_by('opening_date'):
	print(mov.director.name, mov.genre.title, mov.title, mov.opening_date, mov.running_time, mov.screening)
```
...
bong = Director.objects.get(name='봉준호')
for mov in Movie.objects.filter(genre = drama, director = bong).order_by('opening_date'):
	print(mov.director.name, mov.genre.title, mov.title, mov.opening_date, mov.running_time, mov.screening)
```
...
drama = Genre.objects.get(title='드라마')
bong = Director.objects.get(name='봉준호')
for mov in Movie.objects.exclude(director = bong).order_by('opening_date'):
	print(mov.director.name, mov.genre.title, mov.title, mov.opening_date, mov.running_time, mov.screening)
```